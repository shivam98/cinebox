...
public class RecentHindi extends AppCompatActivity {

    //String URL = "https://api.themoviedb.org/3/discover/movie?api_key=60e3c97f405f942ade7455b8d5a6993f&region=IN&with_original_language=hi&release_date.gte=2017-01-01&release_date.lte=2018-03-21";
    String URL = "https://api.themoviedb.org/3/discover/movie?api_key=60e3c97f405f942ade7455b8d5a6993f&region=IN&with_original_language=hi&sort_by=popularity.desc&release_date.gte=2017-08-01&with_release_type=3|2&page=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recent_hindi);
        ...
        StringRequest request = new StringRequest(URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RecentHindi.this,"Something went wrong ! ",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void loadNextDataFromApi(int offset) {
       ...
       String URLNEXT =  "https://api.themoviedb.org/3/discover/movie?api_key=60e3c97f405f942ade7455b8d5a6993f&region=IN&with_original_language=hi&sort_by=popularity.desc&release_date.gte=2017-08-01&with_release_type=3|2&page="+(offset+1);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                adaptorRecentHindi = new AdaptorRecentHindi(RecentHindi.this);
                BmovieList.setAdapter(adaptorRecentHindi);
                ...
                RequestQueue queue = Volley.newRequestQueue(RecentHindi.this);
                queue.add(request);
